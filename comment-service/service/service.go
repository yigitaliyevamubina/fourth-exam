...
func NewCommentService(cluster *gocql.ClusterConfig, collection *mongo.Collection, db *sql.DB, log logger.Logger) *CommentService {
	return &CommentService{
		storage: storage.NewStoragePg(cluster, collection, db, log),
		logger:  log,
		// service: service,
	}
}
